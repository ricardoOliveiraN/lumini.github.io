...
function evolucaoEmpresas(req,res){

    dashFuncModel.evolucaoEmpresas()
        .then(
            function (resultado) {
                if (resultado.length > 0) {
                    res.status(200).json(resultado);
...
function statusLuminosidade(req,res){

    dashFuncModel.statusLuminosidade()
        .then(
            function (resultado) {
                if (resultado.length > 0) {
                    res.status(200).json(resultado);
...
function tamanhoEmpresa(req,res){

    dashFuncModel.tamanhoEmpresa()
        .then(
            function (resultado) {
                if (resultado.length > 0) {
                    res.status(200).json(resultado);
...
function qtdTalhoes(req,res){

    dashFuncModel.qtdTalhoes()
        .then(
            function (resultado) {
                if (resultado.length > 0) {
                    res.status(200).json(resultado);
